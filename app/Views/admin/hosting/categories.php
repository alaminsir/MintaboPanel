<div class="row">
    <div class="col-lg-5 col-md-12">
        <div class="box box-primary">
            ...
            <form action="<?= base_url('Hosting/addCategoryPost'); ?>" method="post">
                <?= csrf_field(); ?>
                <div class="box-body">
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu options-dropdown">
                                                        ...
                                                        <li><a href="javascript:void(0)" onclick="deleteItem('Blog/deleteCategoryPost','<?= $item->id; ?>','<?= trans("confirm_delete", true); ?>');"><i class="fa fa-trash option-icon"></i><?= trans('delete'); ?></a></li>
                                                    </ul>
                                                </div>
                                            </td>
                                        </tr>
