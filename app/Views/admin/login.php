...
<head>
    ...
    <style>.alert{display:inline-block;padding:10px;width:100%;border-radius:2px!important;margin-bottom:10px}.alert h4{font-size:14px;width:auto!important;margin:0;font-weight:400;display:inline-block}.alert-danger{background-color:#f8d7da!important;border-color:#f5c6cb!important;color:#721c24!important}.alert .close{display:none!important}</style>
</head>
<body class="hold-transition login-page">
<div class="login-box">
    <div class="login-logo">
        <a href="<?= adminUrl('login'); ?>"><b></b>&nbsp;<?= trans("panel"); ?></a>
    </div>
