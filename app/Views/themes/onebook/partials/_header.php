...
<head>
    ...
    <meta property="og:url" content="<?= esc(currentFullURL()); ?>" /> <!-- where do you want your post to link to -->
    <meta property="og:type" content="article" />

    <!--favicon icon-->
    <link rel="icon" href="<?= getFavicon();?>" type="image/png" sizes="16x16">
    ...
    <!--build:css-->
    <link rel="stylesheet" href="<?= base_url($assetsPath . '/css/main.css') ?>">
    <!-- endbuild -->
    <link rel="stylesheet" href="<?= base_url($assetsPath . '/css/custom.css') ?>">
</head>
        ...
        <div id="logoAndNav" class="main-header-menu-wrap white-bg border-bottom">
            <div class="container">
                <nav class="js-mega-menu navbar navbar-expand-md header-nav">
                    ...
                    <!--logo start-->
                    <a class="navbar-brand" href="<?= base_url();?>"><img src="<?= getLogo()?>" width="120" alt="logo" class="img-fluid" /></a>
                    <!--logo end-->
