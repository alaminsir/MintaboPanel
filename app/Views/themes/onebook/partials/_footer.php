                ...
                <div class="row align-items-center justify-content-between">
                    <div class="col-md-5 col-lg-5">
                        <p class="copyright-text pb-0 mb-0">Copyrights © 2024. All
                            rights reserved by
                            <a href="<?= langBaseUrl();?>" target="_blank">Mintabo</a>
                        </p>
                    </div>
    ...
    <!--build:js-->
    <script src="<?= base_url($assetsPath . '/js/vendors/jquery-3.5.1.min.js') ?>"></script>
    <script src="<?= base_url($assetsPath .'/js/vendors/bootstrap.bundle.min.js') ?>"></script>
    <script src="<?= base_url($assetsPath .'/js/vendors/bootstrap-slider.min.js') ?>"></script>
    <script src="<?= base_url($assetsPath .'/js/vendors/jquery.countdown.min.js') ?>"></script>
    <script src="<?= base_url($assetsPath .'/js/vendors/jquery.easing.min.js') ?>"></script>
    <script src="<?= base_url($assetsPath .'/js/vendors/owl.carousel.min.js') ?>"></script>
    <script src="<?= base_url($assetsPath .'/js/vendors/validator.min.js') ?>"></script>
    <script src="<?= base_url($assetsPath .'/js/vendors/jquery.waypoints.min.js') ?>"></script>
    <script src="<?= base_url($assetsPath .'/js/vendors/jquery.rcounterup.js') ?>"></script>
    <script src="<?= base_url($assetsPath .'/js/vendors/magnific-popup.min.js') ?>"></script>
    <script src="<?= base_url($assetsPath .'/js/vendors/hs.megamenu.js') ?>"></script>
    <script src="<?= base_url($assetsPath .'/js/app.js') ?>"></script>
    <!--endbuild-->
</body>
