...
class Hosting extends AdminBaseController
{
    ...
    public function posts()
    {
        ...
        $data['posts'] = $this->blogModel->getPostsAdminPaginated($this->perPage, $data['pager']->offset);
    ...
    public function categories()
    {
        ...
        $data['categories'] = $this->hostingModel->getCategories();
        $data['langSearchColumn'] = 2;
        
        echo view('admin/includes/_header', $data);
        echo view('admin/hosting/categories', $data);
        echo view('admin/includes/_footer');
    }
    ...
    public function addCategoryPost()
    {
        ...
        if (!$this->validate(getValRules($val))) {
            ...
            if ($this->hostingModel->addCategory()) {
                setSuccessMessage(trans("msg_added"));
                return redirect()->back();
            }
        }
